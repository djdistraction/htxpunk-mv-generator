...
const STAGE_LABELS: Record<string, string> = {
  ...
  generating_treatment: 'Generating treatment…',
  treatment_pending: '⏳ Awaiting treatment approval',
  extracting_elements: 'Extracting elements…',
  elements_ready: 'Elements ready',
  generating_backgrounds: 'Generating backgrounds…',
  generating_elements: 'Generating element images…',
  building_storyboard: 'Building storyboard…',
  storyboard_pending: '⏳ Awaiting storyboard approval',
...
const APPROVAL_LINKS: Record<string, { label: string; href: string }> = {
  treatment_pending: { label: 'Review Treatment →', href: 'treatment' },
  storyboard_pending: { label: 'Review Storyboard →', href: 'storyboard' },
}

const STAGE_ORDER = [
  'uploaded', 'analyzing', 'analyzed', 'generating_treatment',
  'treatment_pending', 'extracting_elements', 'elements_ready',
  'generating_backgrounds', 'generating_elements', 'building_storyboard',
  'storyboard_pending', 'generating_clips', 'assembling', 'complete',
]
    ...
    <div className="min-h-screen bg-black text-white p-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mt-6 mb-8">
          ...
          <div className="mt-3 flex items-center gap-3">
            <span className={`px-3 py-1 rounded-full text-sm font-medium ${
              ...
              project.stage.includes('pending') ? 'bg-yellow-900 text-yellow-300' :
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
          {[
            { label: 'Elements', href: 'elements', stages: ['elements_ready', 'generating_backgrounds', 'generating_elements', 'building_storyboard', 'storyboard_pending', 'generating_clips', 'assembling', 'complete'] },
            { label: 'Storyboard', href: 'storyboard', stages: ['storyboard_pending', 'generating_clips', 'assembling', 'complete'] },
            { label: 'Production', href: 'production', stages: ['generating_clips', 'assembling', 'complete'] },
          ].map(link => {
